# Geometry Optimization —optimize()andgradient()

# Geometry Optimization — [`optimize()`](api/psi4.driver.optimize.html#psi4.driver.optimize "psi4.driver.optimize") and [`gradient()`](api/psi4.driver.gradient.html#psi4.driver.gradient "psi4.driver.gradient")
...
For further discussion of geometry optimization, see Sec. [Geometry Optimization](optking.html#sec-optking).

[`optimize()`](api/psi4.driver.optimize.html#psi4.driver.optimize "psi4.driver.optimize") is the only command most users will ever need to access directly to perform geometry optimizations. Behind the scenes, [`optimize()`](api/psi4.driver.optimize.html#psi4.driver.optimize "psi4.driver.optimize") is a wrapper that repeatedly calls [`gradient()`](api/psi4.driver.gradient.html#psi4.driver.gradient "psi4.driver.gradient") that computes the gradient then adds a call to the [geometry optimization module](optking.html#sec-optking).

psi4.optimize(_name_[, _molecule_ , _return_wfn_ , _func_ , _mode_ , _dertype_ , _hessian_with_])[[source]](_modules/psi4/driver/driver.html#optimize)
...
_float_ – Total electronic energy of optimized structure in Hartrees.
...
[`psi4.driver.OptimizationConvergenceError`](api/psi4.driver.OptimizationConvergenceError.html#psi4.driver.OptimizationConvergenceError "psi4.driver.OptimizationConvergenceError")

if :py:attr`GEOM_MAXITER <optking.v1.optparams.OptParams.geom_maxiter>` exceeded without reaching geometry convergence.
...
First argument, usually unlabeled. Indicates the computational method to be applied to the database. May be any valid argument to [`psi4.driver.energy()`](api/psi4.driver.energy.html#psi4.driver.energy "psi4.driver.energy").
...
Indicate to additionally return the [`Wavefunction`](api/psi4.core.Wavefunction.html#psi4.core.Wavefunction "psi4.core.Wavefunction") calculation result as the second element (after _float_ energy) of a tuple.
  ...
  - **return_history** ([boolean](notes_py.html#op-py-boolean)) – 
...
Indicate to additionally return dictionary of lists of geometries, energies, and gradients at each step in the optimization.
  ...
  - **engine** ([_str_](https://docs.python.org/3.12/library/stdtypes.html#str "(in Python v3.12)")) – 
...
Indicates the optimization engine to use, which can be either Psi4’s native Optking optimizer or the GeomeTRIC program.
  ...
  - **optimizer_keywords** ([_dict_](https://docs.python.org/3.12/library/stdtypes.html#dict "(in Python v3.12)")) – 
...
Indicates whether analytic (if available) or finite difference optimization is to be performed.
  ...
  - **hessian_with** ([_str_](https://docs.python.org/3.12/library/stdtypes.html#str "(in Python v3.12)")) – 
...
eom-ccsd | equation of motion (EOM) CCSD [[manual]](cc.html#sec-eomcc)  
...
psi4.gradient(_name_[, _molecule_ , _return_wfn_ , _func_ , _dertype_])[[source]](_modules/psi4/driver/driver.html#gradient)
    

Function complementary to [`optimize()`](api/psi4.driver.optimize.html#psi4.driver.optimize "psi4.driver.optimize"). Carries out one gradient pass, deciding analytic or finite difference.

Returns:
    

[`Matrix`](api/psi4.core.Matrix.html#psi4.core.Matrix "psi4.core.Matrix") – Total electronic gradient in Hartrees/Bohr.

Returns:
    

([`Matrix`](api/psi4.core.Matrix.html#psi4.core.Matrix "psi4.core.Matrix"), [`Wavefunction`](api/psi4.core.Wavefunction.html#psi4.core.Wavefunction "psi4.core.Wavefunction")) – gradient and wavefunction when **return_wfn** specified.
