...
Basis sets are selected for each atomic [KIND](../../CP2K_INPUT/FORCE_EVAL/SUBSYS/KIND.html#cp2k-input-force-eval-subsys-kind). The files that contain the basis definitions are listed in [BASIS_SET_FILE_NAME](../../CP2K_INPUT/FORCE_EVAL/DFT.html#CP2K_INPUT.FORCE_EVAL.DFT.BASIS_SET_FILE_NAME "CP2K_INPUT.FORCE_EVAL.DFT.BASIS_SET_FILE_NAME"). CP2K searches these files in the current directory and in the configured CP2K data directory.
[code] 
    &FORCE_EVAL
      &DFT
...
The keyword [BASIS_SET](../../CP2K_INPUT/FORCE_EVAL/SUBSYS/KIND.html#CP2K_INPUT.FORCE_EVAL.SUBSYS.KIND.BASIS_SET "CP2K_INPUT.FORCE_EVAL.SUBSYS.KIND.BASIS_SET") can carry an optional basis type. Without an explicit type, CP2K uses the primary orbital basis:
[code] 
    &KIND O
...
For a simple tested example, see [Run a First Calculation](../../getting-started/first-calculation.html).
...
## See Also
  ...
  - [VandeVondele2007](../../bibliography.html#vandevondele2007)

  - [Iannuzzi2026](../../bibliography.html#iannuzzi2026)
