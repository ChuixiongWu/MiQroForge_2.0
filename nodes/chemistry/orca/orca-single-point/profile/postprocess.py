"""orca-single-point post-processing: parse Mulliken charges from ORCA output."""
import re
import json
...
try:
    ...
    print(f"[orca-single-point] Mulliken report: {len(charges)} atoms")

except Exception as e:
    print(f"[orca-single-point][WARN] Could not parse Mulliken charges: {e}")
    with open(f"{output_dir}/mulliken_report", "w") as f:
